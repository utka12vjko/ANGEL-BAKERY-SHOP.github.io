...
<header class="main-header">
    <nav class="main-nav">
        ...
        <h1 class="business-name"><a href="index.html" class="animate__animated animate__backInDown"> ANGEL BAKERY</a></h1>
        ...
        <ul>
            ...
            <li><a href="makeyourcake.php" class="<?php if($page == 'makeyourcake'){echo 'active';}?>" href="makeyourcake.php">CREATE YOUR CAKE</a></li>
